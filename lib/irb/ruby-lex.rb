  ...
  class RubyLex
    ...
    def should_continue?(tokens, line, line_num)
      ...
      tokens.reverse_each do |t|
        ...
        if t.location.start_line == line_num && t.type != :IGNORED_NEWLINE && t.type != :NEWLINE && t.type != :EOF
    ...
    def check_code_syntax(code, local_variables:)
      ...
      result.errors.each do |error|
        ...
        when / meets end of file|end-of-input|unterminated |cannot parse|could not parse/i
    ...
    # Check if the node on the last line is connected to previous line.
    # Connected example:
    #   foo
    #   .bar; baz
